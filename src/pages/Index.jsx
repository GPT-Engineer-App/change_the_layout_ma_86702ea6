...
const Index = () => {
  let startFare = 0;
  let distanceFare = 0;
  let additionalPassengersFare = 0;
  let childrenFare = 0;
  let luggageFare = 0;
  let cyclesFare = 0;
            ...
            Calculate Fare
              ...
              <Text fontSize="2xl" mt={8}>
                ...
                <Text fontSize="sm" mt={2}>
                  ...
                  <br />Start Fare: £{startFare.toFixed(2)}
                  <br />Distance Fare: £{distanceFare.toFixed(2)}
                  <br />Additional Passengers Fare: £{additionalPassengersFare.toFixed(2)}
                  <br />Children Fare: £{childrenFare.toFixed(2)}
                  <br />Luggage Fare: £{luggageFare.toFixed(2)}
                  <br />Cycles Fare: £{cyclesFare.toFixed(2)}
                  <br />Waiting Time Fare: £{waitingTimeFare.toFixed(2)}
                </Text>
                Estimated Fare: <strong>£{fare}</strong>
                <Text fontSize="sm" mt={2}>
                  <strong>Breakdown:</strong>
